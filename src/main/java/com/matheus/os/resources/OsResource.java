package com.matheus.os.resources;
...
import com.matheus.os.services.OsService;
...
public class OsResource {
	...
	public ResponseEntity<List<OSDTO>> findAll() {
		List<OSDTO> list = service.finaAll().stream().map(obj -> new OSDTO(obj)).collect(Collectors.toList());
